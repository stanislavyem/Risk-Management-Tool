    ...
    <footer>
      <div className="container_page container_content">
        ...
        {/* <div className="disclaimer">
					<p>By accessing this website, you agree to the RickCtrlPro <Link href={linkTerms}>Terms of Service</Link> and <Link href={linkPrivacy}>Privacy Policy</Link>.</p>
					<div role='navigation'>
        ...
        {/* <div className="copyright">
					<p>Copyright © 2026 <Link href={linkHome}>RickCtrlPro</Link></p>
				</div> */}
